...
import com.hidevelopers.sharepal.di.AppModule_ProvideExternalStorageRepositoryFactory;
import com.hidevelopers.sharepal.di.AppModule_ProvideMainDispatcherFactory;
import com.hidevelopers.sharepal.presentation.ui.share.ShareViewModel;
import com.hidevelopers.sharepal.presentation.ui.share.ShareViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC extends BaseApplication_HiltComponents.SingletonC {
  ...
  private volatile Object externalStorageRepository = new MemoizedSentinel();

  private volatile Object coroutineDispatcher = new MemoizedSentinel();
  ...
  private ExternalStorageRepository externalStorageRepository() {
    Object local = externalStorageRepository;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = externalStorageRepository;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideExternalStorageRepositoryFactory.provideExternalStorageRepository();
          externalStorageRepository = DoubleCheck.reentrantCheck(externalStorageRepository, local);
        }
      }
    }
    return (ExternalStorageRepository) local;
  }

  private CoroutineDispatcher coroutineDispatcher() {
    Object local = coroutineDispatcher;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = coroutineDispatcher;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideMainDispatcherFactory.provideMainDispatcher();
          coroutineDispatcher = DoubleCheck.reentrantCheck(coroutineDispatcher, local);
        }
      }
    }
    return (CoroutineDispatcher) local;
  }
  ...
  private static final class ActivityRetainedCImpl extends BaseApplication_HiltComponents.ActivityRetainedC {
    ...
    private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
      ...
      private ShareViewModel shareViewModel() {
        return new ShareViewModel(singletonC.externalStorageRepository(), singletonC.coroutineDispatcher());
      }

      private Provider<ShareViewModel> shareViewModelProvider() {
        Object local = shareViewModelProvider;
        if (local == null) {
          local = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 0);
          shareViewModelProvider = (Provider<ShareViewModel>) local;
        }
        return (Provider<ShareViewModel>) local;
      }

      @Override
      public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
        return Collections.<String, Provider<ViewModel>>singletonMap("com.hidevelopers.sharepal.presentation.ui.share.ShareViewModel", (Provider) shareViewModelProvider());
      }
      ...
      private static final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // com.hidevelopers.sharepal.presentation.ui.share.ShareViewModel 
            return (T) viewModelCImpl.shareViewModel();
