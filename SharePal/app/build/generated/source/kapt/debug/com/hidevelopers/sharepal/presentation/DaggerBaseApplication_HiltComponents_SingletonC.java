...
import com.hidevelopers.sharepal.di.AppModule_ProvideApplicationContextFactory;
  ...
  private Context context() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = context;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideApplicationContextFactory.provideApplicationContext(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
  ...
  private static final class ActivityRetainedCImpl extends BaseApplication_HiltComponents.ActivityRetainedC {
    ...
    private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
      ...
      private StorageRepo storageRepo() {
        return new StorageRepo(singletonC.context());
      }

      private ShareViewModel shareViewModel() {
        return new ShareViewModel(storageRepo(), singletonC.coroutineDispatcher());
      }
